...
def upgrade() -> None:
    ...
    sa.Column('authors', sa.JSON(), nullable=True, comment='List of author names'),
    sa.Column('tags', sa.JSON(), nullable=True, comment='Topics: ML, NLP, Computer Vision, etc.'),
    ...
    sa.Column('video_url', sa.String(length=500), nullable=True, comment='YouTube link to demo video'),
    sa.Column('supplementary_files', sa.JSON(), nullable=True, comment='Additional file paths (images, data, etc.)'),
